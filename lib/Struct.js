...
let struct = class Struct {
  ...
  constructor(...definitions){
    ...
    for(let definition of definitions){
      ...
      if(!this[Symbol.for("recursive")]) this[Symbol.for("recursive")] = typeof data == "string";
      ...
      Object.defineProperty(this, name, {
        ...
        set: (value) => {
          if(this[Symbol.for("recursive")]) throw new Error("Recursive Struct are Read-Only");
          if(type == "char" && typeof value == "string"){
            value = value.split("");
            for(let i=0; i<value.length; i++){
              if(i>=data) break;
              this.#struct[name][i] = value[i];
            }
            return true;
          }
...
Struct.recursive = function recursive(struct_t){ return struct_t[Symbol.for("recursive")] }
